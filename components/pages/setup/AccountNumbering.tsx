                    ...
                    <table className="w-full text-sm text-left">
                        <thead className="text-xs text-slate-500 uppercase bg-slate-50">
                            <tr>
                                ...
                                <th className="px-6 py-3">Nama Grup</th>
                                <th className="px-6 py-3">Jumlah Digit</th>
                                <th className="px-6 py-3">Nomor Akun Awal</th>
                                <th className="px-6 py-3">Nomor Akun Akhir</th>
                        ...
                        <tbody>
                            {accountNumberingRules.map((rule, index) => (
                                <tr key={rule.id} className="border-b hover:bg-slate-50">
                                    ...
                                    <td className="px-6 py-4">{rule.digits}</td>
                                    <td className="px-6 py-4">{rule.start}</td>
                                    <td className="px-6 py-4">{rule.end}</td>
